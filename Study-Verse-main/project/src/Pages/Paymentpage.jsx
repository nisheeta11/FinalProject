...
//     if (!selectedMethod || !user || !user._id || !cartItems.length) {
//       alert('Missing required payment information.');
//       return;
//     }

//     // You can add your payment logic here for eSewa, Khalti, Visa, MasterCard
//     alert(`${selectedMethod} payment is not implemented yet.`);
//   };
...
//               onClick={() => setSelectedMethod(name)}
//             >
//               <img src={image} alt={name} style={{ width: 60, height: 40 }} />
//               <span>{name}</span>
//             </div>
//           ))}
//         </div>
